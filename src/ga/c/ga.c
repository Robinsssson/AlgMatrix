...
// static alg_vector *crossover(ga_handle *ga, alg_vector *parent1, alg_vector *parent2, alg_vector **child1, alg_vector **child2) {
//     int cross_number = alg_random_int(0, ga->args_number + 1);
//     // alg_vector_slice(parent1, int range_l, int range_r)
//     return child;
// }
